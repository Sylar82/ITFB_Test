...
// Оплата билетов
    ...
    private static WebElement passFirst0;
    ...
    static Select delCountry;
...

            {
                ...
                departFlight = driver.findElement(By.xpath("//table/tbody/tr[1]/td[1]/b/font")).getText();
                Assert.assertEquals(summaryDepart, departFlight);

                summaryDepartDate = driver.findElement(By.xpath("//table/tbody/tr[1]/td[2]/b/font")).getText();
                ...
                returnFlight = driver.findElement(By.xpath("//tbody/tr[4]/td[1]/b/font")).getText();
                ...
                summaryClass = driver.findElement(By.xpath("//table/tbody/tr[6]/td[2]/font")).getText();
                ...
                summaryTotalPrice = driver.findElement(By.("//table/tbody/tr[9]/td[2]/font/b")).getText();
